        ...
        _calculatePosition: function(field, promptElmt, options) {
            ...
            switch (options.promptPosition) {
                ...
                case "topRight":
                    if (overflow)
                        // Is the form contained in an overflown container?
                        promptleftPosition += fieldWidth - 170;
                    else {
                        promptleftPosition += fieldWidth - 170;
                    ...
                    break;
                case "topLeft":
                    promptTopPosition += -promptHeight - 150;
                    break;
                case "centerRight":
                    promptleftPosition += fieldWidth + 153;
                    break;
                case "bottomLeft":
                    promptTopPosition = promptTopPosition + field.height() + 155;
                    break;
                case "bottomRight":
                    promptleftPosition += fieldWidth - 160;
                    promptTopPosition += field.height() + 145;
            }
